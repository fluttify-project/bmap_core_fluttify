...
class BMKBaseLog extends NSObject  {
  ...
  static Future<void> setlogEnable_module(bool enable, BMKMapModule mapModule) async {
    ...
    // invoke native method
    final __result__ = await kBmapCoreFluttifyChannel.invokeMethod('BMKBaseLog::setlogEnable_module', {"enable": enable, "mapModule": mapModule.toValue()});
...
extension BMKBaseLog_Batch on List<BMKBaseLog> {
  ...
  static Future<List<void>> setlogEnable_module_batch(List<bool> enable, List<BMKMapModule> mapModule) async {
    ...
    // invoke native method
    final resultBatch = await kBmapCoreFluttifyChannel.invokeMethod('BMKBaseLog::setlogEnable_module_batch', [for (int __i__ = 0; __i__ < enable.length; __i__++) {"enable": enable[__i__], "mapModule": mapModule[__i__].toValue()}]);
